...
const FailedTask = () => {
  ...
  return (
    <div className='w-full min-h-[300px] md:min-h-[300px] md:w-[400px] p-5 bg-orange-500 flex-shrink-0 rounded-xl flex flex-col gap-3 justify-between '>
            <div className='flex justify-between text-sm items-center font-semibold'><div className='flex gap-2'>
              <p className='bg-black bg-opacity-50 py-2 px-3 rounded-full'>{status}</p>
        ...
        <div className='flex justify-center mt-3'>
            <button className='bg-red-900 py-2 px-3 text-sm rounded-md w-full'>Failed</button>
        </div>
    </div>
  )
}
